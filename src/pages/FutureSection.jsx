...
import futureBackgroundVideo from '../assets/videos/the_future.mp4';

const FutureSection = () => {
  return (
    <div className="relative h-screen px-6 py-4 border-4 overflow-hidden">
      
      {/* Background Video (Sticks to this Section) */}
      <div className="absolute inset-0 z-[-1]">
        <video 
          className="w-full h-full object-cover" 
          src={futureBackgroundVideo} 
          autoPlay 
          loop 
          muted 
          playsInline
      ...
      {/* Text Section (Scrolls Over Video) */}
